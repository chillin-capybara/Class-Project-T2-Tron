...
class HeadWidget(Widget):
    ...
    def calculatePoints(self):
        ...
        nowpoint = (
            playPos.x * (self.screen_size[0]/self.fieldsize[0]), 
            playPos.y * (self.screen_size[1]/self.fieldsize[1])
        )
        
        if velocity == Vect2D(1, 0):
            xPos1 = nowpoint[0]  + (0.5*tracksize)*(self.screen_size[0]/self.fieldsize[0])
            yPos1 = nowpoint[1] - headsize*(self.screen_size[1]/self.fieldsize[1]) + (0.5*tracksize)*(self.screen_size[1]/self.fieldsize[1])

            xPos2 = nowpoint[0] + (0.5*tracksize)*(self.screen_size[0]/self.fieldsize[0])
            yPos2 = nowpoint[1] + headsize*(self.screen_size[1]/self.fieldsize[1]) + (0.5*tracksize)*(self.screen_size[1]/self.fieldsize[1])

            xPos3 = nowpoint[0] + headsize*(self.screen_size[0]/self.fieldsize[0]) + (0.5*tracksize)*(self.screen_size[0]/self.fieldsize[0])
            yPos3 = nowpoint[1] + (0.5*tracksize)*(self.screen_size[1]/self.fieldsize[1])

            return [xPos1, yPos1, xPos2, yPos2, xPos3, yPos3]

        if velocity == Vect2D(0, 1):
            xPos1 = nowpoint[0] - headsize * (self.screen_size[0]/self.fieldsize[0]) + (0.5*tracksize)*(self.screen_size[0]/self.fieldsize[0])
            yPos1 = nowpoint[1] + (0.5*tracksize)*(self.screen_size[1]/self.fieldsize[1])
        ...
        if velocity == Vect2D(-1, 0):
            xPos1 = nowpoint[0] - headsize * (self.screen_size[0]/self.fieldsize[0])
            yPos1 = nowpoint[1]  + (0.5*tracksize)*(self.screen_size[1]/self.fieldsize[1])
            ...
            xPos3 = nowpoint[0] 
            yPos3 = nowpoint[1] - headsize * (self.screen_size[0]/self.fieldsize[0]) + (0.5*tracksize)*(self.screen_size[1]/self.fieldsize[1])
        ...
        if velocity == Vect2D(0, -1):
            ...
            xPos2 = nowpoint[0]+  (0.5*tracksize) * (self.screen_size[0]/self.fieldsize[0])
            yPos2 = nowpoint[1] - headsize*(self.screen_size[1]/self.fieldsize[1])
